...
import { Sun, Moon, Monitor, ChevronDown, LogOut, User, Shield, BookOpen } from 'lucide-react';
                ...
                <div className="absolute right-0 top-full mt-2 w-56 z-50 glass rounded-lg py-2">
                  ...
                  <div className="border-t border-border mt-1 pt-1">
                    <button
                      ...
                      className="flex items-center gap-3 px-4 py-2 text-sm text-danger hover:bg-surface-hover transition-colors w-full"
                    >
